...
export const HeroSlider = ({slice}:any) => {
  return (
    <>
      <article
        id='home'
        className='relative z-10 overflow-hidden pt-40 pb-16 md:pb-[120px] xl:pb-[160px] 2xl:pb-[200px] dark:bg-gray-900'
      >
        <div className='bg-white relative pt-20 pb-20 lg:pt-20 dark:bg-gray-900'>
            ...
            <div className='lg:flex'>
              ...
              <div className='mt-12 md:mt-0 lg:absolute -right-10 lg:w-7/12 top-[-120px] overflow-x-visible'>
                <div className='relative w-full'>
                  ...
                  {/*<img src={nao.src} className="relative w-full" alt="wath illustration" loading="lazy" width="320" height="280" />*/}
                </div>
              </div>
            </div>
          </div>
