          ...
          <div className='-mx-4 flex flex-wrap'>
            <div className='w-full px-4'>
              <div className='mx-auto max-w-[530px] text-center'>
                <div className='flex items-center justify-center mx-auto mb-9 text-center'>
                  <Image
                    src={logo}
                    alt='logo'
                    width={300}
                ...
                <Link
                  href='/'
                  className='rounded-md bg-blue-900 dark:bg-blue-500 py-3 px-8 text-base font-bold text-white shadow-signUp duration-300 hover:bg-blue-300 dark:hover:bg-blue-900 hover:text-primary md:px-9 lg:px-8 xl:px-9'
                >
                  Back to Homepage
                </Link>
              </div>
