...
export default function Home() {
    return (
        <main className="flex min-h-screen flex-col items-center align-items-center place-items-center justify-center light-blue-400">
            <div className="flex-col relative place-items-center align-items-center">
                ...
                <div className="mt-9 flex-row align-items-center justify-center">
                    <div className="flex-row flex justify-around align-middle">
                        <a
                            href="https://www.instagram.com/urubotsutec/"
                            target={"_blank"}
                            rel={"noreferrer"}
                        ...
                        <a
                            href="https://www.youtube.com/@urubotsutec8380"
                            target={"_blank"}
                            rel={"noreferrer"}
                        ...
                        <a
                            href="https://www.linkedin.com/company/urubots"
                            target={"_blank"}
                            rel={"noreferrer"}
